...
d=["SHS","CEO", "PVS", "MBS","HUT","TTH","LAS","TIG","PVC","BVS","IDC","HTP","AAV","DDG","IDJ","VGS","TNG","MST","AMV","VC3"]
st.write(f'<div style="text-align:center;font-size:40px;font-weight:bold;">HNX</div>',
