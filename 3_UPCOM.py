...
d=["AAH","BSR","AAS","SBS","VGI","DDV","VHG","DRI","VEA", "DGT","C4G","VAB","QTP","BCR","BMS","ICF","BOT","KVC","OIL"]
st.write(f'<div style="text-align:center;font-size:40px;font-weight:bold;">UPCOM</div>',
